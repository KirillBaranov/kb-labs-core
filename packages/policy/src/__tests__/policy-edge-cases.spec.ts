...
describe('Policy Engine Edge Cases', () => {
  ...
  describe('Permission Checking Edge Cases', () => {
    ...
    it('should handle wildcard actions', () => {
      ...
      const permitsDeveloper = createPermitsFunction(policy, { roles: ['developer'] });
    ...
    it('should handle multiple roles', () => {
      ...
      const permits = createPermitsFunction(policy, { roles: ['developer', 'user'] });
  ...
  describe('Policy Merge Edge Cases', () => {
    it('should merge multiple rules for same action', async () => {
      ...
      const permits = createPermitsFunction(result.policy, { roles: ['developer'] });
    ...
    it('should handle conflicting allow/deny rules', async () => {
      ...
      const permits = createPermitsFunction(result.policy, { roles: ['admin'] });
