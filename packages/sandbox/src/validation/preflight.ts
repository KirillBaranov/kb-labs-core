/**
 * @module @kb-labs/sandbox/validation/preflight
...
async function checkBootstrapFile(): Promise<boolean> {
  try {
    const packageUrl = await import.meta.resolve('@kb-labs/sandbox');
    ...
    for (let i = 0; i < 10; i++) {
      ...
      // Check for node_modules/@kb-labs/sandbox
...
async function checkDependencies(): Promise<boolean> {
  try {
    ...
    await import.meta.resolve('@kb-labs/sandbox');
  ...
  const checks: PreflightCheck[] = [
    {
      ...
      suggestions: [
        ...
        'Check that @kb-labs/sandbox package is properly installed',
      ],
    },
    {
    ...
    },
    {
      ...
      suggestions: [
        ...
        'Check that @kb-labs/sandbox is properly linked',
      ],
    },
    {
