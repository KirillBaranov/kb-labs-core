/**
 * @module @kb-labs/sandbox/observability/outputs/file-logger
...
import type { ObservabilityEvent } from '../events/schema.js';
import type { EventSink, EventSinkOptions } from './types.js';
