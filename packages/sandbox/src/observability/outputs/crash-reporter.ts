/**
 * @module @kb-labs/sandbox/observability/outputs/crash-reporter
 * Rich crash report generation with diagnostics
 *
 * Generates beautiful, actionable crash reports with memory analysis
 */

import type { HeapAnalysisResult, MemoryConsumer } from '../profiling/heap-analyzer.js';
import type { OOMWarning } from '../profiling/pre-oom-detector.js';
