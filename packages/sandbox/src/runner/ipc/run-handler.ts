/**
 * @module @kb-labs/sandbox/runner/ipc/run-handler
...
import type { EventCollector, TraceRecorder, ExecutionContext as ObservabilityExecutionContext } from '../../observability/index.js';
import { createLogEvent, createMemoryEvent } from '../../observability/index.js';
import { SANDBOX_ERROR_CODES } from '../../errors/error-codes.js';
import type { HandlerResult } from '../execution/handler-executor.js';
import type { RunMessagePayload } from './message-types.js';
