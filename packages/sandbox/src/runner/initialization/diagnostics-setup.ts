/**
 * @module @kb-labs/sandbox/runner/initialization/diagnostics-setup
 * Initialize diagnostic tools for subprocess execution
 */

import { ModuleTracker } from '../../diagnostics/module-tracker.js';
import { HeapMonitor } from '../../diagnostics/heap-monitor.js';
